...
@interface LGFollowViewController () <MJRefreshBaseViewDelegate>
...
@implementation LGFollowViewController
...
- (void)loadMoreStatues
{
    ...
    [LGFriendshipTool followerWithParam:param success:^(LGfriendResult *result) {
        _result = result;
